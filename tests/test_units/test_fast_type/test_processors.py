...
class TestType3Processor:
    ...
    def test_process_type3_variants(self, backend, lines, n_inputs, n_outputs, verbose):
        """Test TYPE3 processing with various configurations (STR5: merged 4 variants + STR11: 2 pairs)."""
        result = process_type3(lines, n_inputs, n_outputs, backend=backend, verbose=verbose)
        assert result
...
class TestType4Processor:
    ...
    def test_process_type4_variants(self, backend, lines, verbose):
        """Test TYPE4 processing with various configurations (STR5: merged 4 variants)."""
        result = process_type4(lines, n_inputs=1, n_outputs=1, backend=backend, verbose=verbose)
        assert result
...
class TestType5Processor:
    ...
    def test_process_type5_variants(self, backend, lines, verbose):
        """Test TYPE5 processing with various configurations (STR5: merged 4 variants)."""
        result = process_type5(lines, n_inputs=1, n_outputs=1, backend=backend, verbose=verbose)
        assert result
